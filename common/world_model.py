...
class WorldModel_new(nn.Module):
    """
    ...
    def __init__(self, cfg):
        ...
        self._uncertainty = layers.mlp(cfg.latent_dim + cfg.task_dim, 2 * [cfg.mlp_dim], max(cfg.num_bins, 1))
    ...
    def encode(self, obs, task):
		...
		"""
        uncertainty = obs[..., -1:]
        z = self._encoder['state'](obs)
        return z, uncertainty

    def uncertainty(self, z, task):
        return self._uncertainty(z)
